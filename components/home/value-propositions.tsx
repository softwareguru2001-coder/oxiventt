...
export function ValuePropositions() {
  return (
    <section className="relative py-16 sm:py-20 md:py-24 lg:py-28 bg-gradient-to-br from-industrial-900 via-industrial-800 to-industrial-900 overflow-hidden">
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-8 relative z-10">
            ...
            >
              <div className="relative p-6 sm:p-8 rounded-xl sm:rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 hover:border-white/20 transition-all duration-500 overflow-hidden">
                ...
                <div className="relative z-10">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mb-4 sm:mb-6 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-white/10 flex items-center justify-center text-blue-300 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 backdrop-blur-sm">
                    {value.icon}
                  </div>
        ...
        <motion.div
          ...
          className="mt-12 sm:mt-16 p-6 sm:p-8 md:p-12 rounded-2xl sm:rounded-3xl bg-gradient-to-r from-blue-600/20 to-cyan-600/20 backdrop-blur-md border border-white/10"
        >
          <div className="grid grid-cols-3 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8 text-center">
            <div>
              ...
              <div className="text-xs sm:text-sm md:text-base text-white/70 font-medium">Years Experience</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 sm:mb-2">5000+</div>
              <div className="text-xs sm:text-sm md:text-base text-white/70 font-medium">Installations</div>
            </div>
            <div>
              <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-1 sm:mb-2">98%</div>
              <div className="text-xs sm:text-sm md:text-base text-white/70 font-medium">Client Satisfaction</div>
            </div>
          </div>
        </motion.div>
      </div>
