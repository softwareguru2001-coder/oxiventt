...
export function ProductDetailClient({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-white">
      <div className="relative bg-gradient-to-br from-slate-900 via-industrial-900 to-slate-950 text-white pt-24 pb-28 sm:pt-28 sm:pb-32 md:pt-32 md:pb-36 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 -mt-24 relative z-20">
