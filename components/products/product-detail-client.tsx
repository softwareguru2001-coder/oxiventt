...
export function ProductDetailClient({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-slate-50 to-white">
      <div className="relative bg-gradient-to-br from-slate-900 via-industrial-900 to-slate-950 text-white py-6 md:py-8 overflow-hidden">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <nav className="flex items-center gap-2 text-sm text-white/60 mb-0">
            ...
            >
              <div>
                ...
                <motion.h1
                  ...
                  className="text-3xl md:text-4xl lg:text-5xl font-bold text-industrial-900 mb-5 leading-[1.15]"
                >
                  {product.name}
                </motion.h1>
