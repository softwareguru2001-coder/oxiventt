        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-8 relative z-10">
          ...
          >
            <motion.div
              ...
              className="inline-block mb-4 sm:mb-6 px-4 py-2 sm:px-5 sm:py-2.5 rounded-full bg-white/10 backdrop-blur-md border border-white/20"
            >
              <span className="text-xs sm:text-sm font-bold text-white">Premium Industrial Solutions</span>
            </motion.div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-white via-blue-100 to-cyan-100 bg-clip-text text-transparent leading-tight px-4">
              Our Products
            </h1>
